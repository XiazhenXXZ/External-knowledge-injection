...
class DisassemblyEnv(gym.Env):
    ...
    def go_to_joint_state(self):
        ...
        joint_goal[0] = 1.3833963059445722
        joint_goal[1] = -1.5387714339641103
        joint_goal[2] = -1.9441383834708876 
        joint_goal[3] = -2.146695026987886
        joint_goal[4] = -0.0716343073002344
        joint_goal[5] = 1.9314261360565086
        joint_goal[6] = 0.4024550862643454
    ...
    #     group.set_pose_target(pose_goal_4)
    #     group.go(wait=True)
    ...
    #     pose_goal_6.positio0.490918888422584n.y = pos[1, 3]
    ...
    #     pose_goal_7.orientation.zposition_limits_violation or msg.last_motion_errors.cartesian_re = quat_rr[2]
    ...
    #     current_pose = self.group.get_current_pose().pose
    #     time.sleep(1)position_limits_violation or msg.last_motion_errors.cartesian_re
    ...
    def step(self, action):
        ...
        elif EEP_x >= 0.475 or EEP_x <=0.42:
            self.terminated = True
            self.reward -= 10
            print("X_Fail")
            # print("Fail_Force", self.Force)
        ...
        elif EEP_x_1 >= 0.475 or EEP_x_1 <=0.42:
            self.terminated = True
            self.reward -= 10
            print("X_1_Fail")
            # print("Fail_Force", self.Force)
        ...
        elif EEP_y <= -0.011 or EEP_y >= 0.022:
            self.terminated = True
            self.reward -= 10
            print("Y_Fail")
